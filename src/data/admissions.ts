...
const stages = ["new_inquiry", "tour_scheduled", "waitlist", "enrolled", "rejected"] as const;

const cardData: Omit<AdmissionCard, "stage">[] = [
  { id: "a1", studentName: "Yusuf Ahmed", age: 3, parentName: "Kamran Ahmed", program: "Daycare", branchId: "branch-nn", daysInStage: 2, avatar: "https://i.pravatar.cc/150?img=52", createdAt: "2025-06-20" },
  ...
  { id: "a6", studentName: "Zara Mahmood", age: 4, parentName: "Tariq Mahmood", program: "Preschool", branchId: "branch-clifton", daysInStage: 12, avatar: "https://i.pravatar.cc/150?img=57", createdAt: "2025-06-10" },
  ...
  { id: "a12", studentName: "Noor Fatima", age: 5, parentName: "Hamza Fatima", program: "Kindergarten", branchId: "branch-gulshan", daysInStage: 20, avatar: "https://i.pravatar.cc/150?img=63", createdAt: "2025-06-02" },
  ...
  { id: "a28", studentName: "Areeba Khan", age: 5, parentName: "Shahbaz Khan", program: "Kindergarten", branchId: "branch-gulshan", daysInStage: 16, avatar: "https://i.pravatar.cc/150?img=79", createdAt: "2025-06-06" },
