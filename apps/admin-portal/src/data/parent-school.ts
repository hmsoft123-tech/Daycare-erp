...
/** Mutable store — source of truth for parent portal School modules */
export const parentSchoolAttendance: ParentSchoolAttendance[] = [
  { id: "at1", childId: "s1", childName: "Hamdan", date: "2026-08-10", status: "present", classId: "c1", checkIn: "08:12 AM", checkOut: "01:05 PM" },
  { id: "at2", childId: "s1", childName: "Hamdan", date: "2026-08-09", status: "present", classId: "c1", checkIn: "08:20 AM", checkOut: "01:00 PM" },
  { id: "at3", childId: "s1", childName: "Hamdan", date: "2026-08-08", status: "late", classId: "c1", checkIn: "09:05 AM", checkOut: "01:10 PM", note: "Traffic delay" },
  { id: "at4", childId: "s1", childName: "Hamdan", date: "2026-08-07", status: "absent", classId: "c1", note: "Family travel" },
  { id: "at5", childId: "s1", childName: "Hamdan", date: "2026-08-06", status: "present", classId: "c1", checkIn: "08:15 AM", checkOut: "01:00 PM" },
  { id: "at6", childId: "s2", childName: "Zainab", date: "2026-08-10", status: "present", classId: "c2", checkIn: "08:18 AM", checkOut: "12:45 PM" },
  { id: "at7", childId: "s2", childName: "Zainab", date: "2026-08-09", status: "present", classId: "c2", checkIn: "08:10 AM", checkOut: "12:50 PM" },
  { id: "at8", childId: "s2", childName: "Zainab", date: "2026-08-08", status: "leave", classId: "c2", note: "Medical appointment" },
  { id: "at9", childId: "s2", childName: "Zainab", date: "2026-08-07", status: "present", classId: "c2", checkIn: "08:22 AM", checkOut: "12:55 PM" },
  { id: "at10", childId: "s2", childName: "Zainab", date: "2026-08-06", status: "late", classId: "c2", checkIn: "08:48 AM", checkOut: "12:40 PM" },
  { id: "at11", childId: "s1", childName: "Hamdan", date: "2026-07-28", status: "present", classId: "c1", checkIn: "08:10 AM", checkOut: "01:00 PM" },
  { id: "at12", childId: "s1", childName: "Hamdan", date: "2026-07-15", status: "absent", classId: "c1", note: "Fever" },
  { id: "at13", childId: "s2", childName: "Zainab", date: "2026-07-28", status: "present", classId: "c2", checkIn: "08:05 AM", checkOut: "12:50 PM" },
  { id: "at14", childId: "s2", childName: "Zainab", date: "2026-06-20", status: "late", classId: "c2", checkIn: "08:55 AM", checkOut: "12:40 PM" },
  { id: "at15", childId: "s1", childName: "Hamdan", date: "2025-12-18", status: "present", classId: "c1", checkIn: "08:14 AM", checkOut: "01:00 PM" },
  { id: "at16", childId: "s2", childName: "Zainab", date: "2025-12-18", status: "leave", classId: "c2", note: "Family event" },
];

export const parentSchoolHomework: ParentSchoolHomework[] = [
  {
    id: "hw1",
    childId: "s1",
    childName: "Hamdan",
...
export const parentSchoolAssignments: ParentSchoolAssignment[] = [
  {
    id: "as1",
    childId: "s1",
    childName: "Hamdan",
...
export const parentSchoolProgress: ParentSchoolProgress[] = [
  {
    id: "pr1",
    childId: "s1",
...
export const parentSchoolNotices: ParentSchoolNotice[] = [
  {
    id: "n1",
...
export const parentSchoolSyllabus: ParentSchoolSyllabus[] = [
  {
    id: "sy1",
    childId: "s1",
    childName: "Hamdan",
