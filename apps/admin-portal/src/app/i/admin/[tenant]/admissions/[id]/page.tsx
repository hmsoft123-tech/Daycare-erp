      ...
      <Card className="max-w-2xl">
        <CardContent className="space-y-4 p-6">
          ...
          <dl className="grid gap-3 text-sm sm:grid-cols-2">
            <div><dt className="text-gray-500">Tag</dt><dd className="font-medium capitalize">{admission.tag.replace(/_/g, " ")}</dd></div>
            <div><dt className="text-gray-500">Type</dt><dd className="font-medium capitalize">{admission.type}</dd></div>
            ...
            <div><dt className="text-gray-500">Email</dt><dd className="font-medium">{admission.email}</dd></div>
